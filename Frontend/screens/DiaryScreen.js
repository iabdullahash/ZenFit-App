...
import Animated, {FadeInUp,FadeInDown, FadeInRight , FadeInLeft, FadeOutRight} from 'react-native-reanimated';
      ...
      return (
        <View style={styles.mealSection}>
          ...
          {mealItems.map((item, index) => (
            <Animated.View entering={FadeInLeft.delay(400).duration(500)} exiting={FadeOutRight.delay(0).duration(500)} key={index}>
            <TouchableOpacity
              key={index}
